...
from run_coalition_relations_once_v03 import run_latest, run_scan
...
def main() -> None:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        assert latest["active_relation_count"] >= 1, latest
        assert latest["strong_coalition_count"] == 0, latest
        assert "RELATION ACTIVE" in latest["cockpit_sentence"], latest["cockpit_sentence"]
        ...
        assert scan["active_window_count"] >= 1, scan

        print("OK run_coalition_relations_once V0.3")
        print(latest["cockpit_sentence"])
        print("active windows:", scan["active_window_count"])
        print("strong coalition windows:", scan["strong_coalition_window_count"])
