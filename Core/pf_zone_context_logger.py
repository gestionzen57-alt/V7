...
def build_zone_diagnostic_row(
    ...
    *,
    ...
    context_tags = data.get("context_tags", data.get("contextual_tags", [])) or []
...
# V0.1.1 patch:
# - Accepts both context_tags and contextual_tags from ZoneDiagnosis.to_dict().
# - Keeps DB schema unchanged: context_tags_json remains the persisted JSON field.
