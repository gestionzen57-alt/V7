"""CLI runner for T009 Sequence Summarizer V3.1.1 / B9."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="T009 Sequence Summarizer V3.1.1")
...
def main() -> int:
    ...
    print("T009 Sequence Summarizer V3.1.1")
