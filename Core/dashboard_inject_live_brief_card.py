...
START = "<!-- POWERFLOW_V733_LIVE_BRIEF_CARD_START -->"
END = "<!-- POWERFLOW_V733_LIVE_BRIEF_CARD_END -->"


def main(argv: Optional[Sequence[str]] = None) -> int:
    parser = argparse.ArgumentParser()
    parser.add_argument("--dashboard", default="dashboard_live.html")
    parser.add_argument("--card", default="dashboard_live_brief_card_patch.html")
    ...
    backup = dashboard.with_name(dashboard.name + ".bak_live_brief_" + datetime.now().strftime("%Y%m%d_%H%M%S"))
