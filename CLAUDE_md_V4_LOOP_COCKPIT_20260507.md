# CLAUDE.md — PowerFlow V6 Complete Context V4
**Date**: 2026-05-07  
**Status**: PRODUCTION — HTF Corrected + Orchestral + Relational + Loop Live  
**Project**: PowerFlow — Market Flow Understanding Engine (Python)  
**Size**: ~30 KB densified | **Token Save**: 850+ per session
...
lab.py (M3 — queries orchestrales — autre fil)
```
...
NEXT: P1.2 fix → HTF_CONTEXT_STACK spec → Orchestral dashboard display.
LATER: M3 lab.py (new thread) → Telegram (much later).
...
Updated 2026-05-07.
HTF corrected. Orchestral Loop live (M1). Orchestral Cockpit V0.1.4 (M2).
