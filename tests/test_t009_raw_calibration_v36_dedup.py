...
def test_no_db_write_statements_in_raw_calibration_module():
    source = Path("pf_t009_raw_calibration.py").read_text(encoding="utf-8")
...
def test_no_decision_language_in_raw_calibration_report():
    report = Path("Docs/Reports/B9_RAW_CALIBRATION_V36_DEDUP_REPORT.md").read_text(encoding="utf-8")
